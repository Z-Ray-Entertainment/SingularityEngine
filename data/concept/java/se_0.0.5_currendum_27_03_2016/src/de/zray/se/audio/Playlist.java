...
public class Playlist {
    ...
    private void play(){
        ...
        if(loopMode == LoopMode.LOOP_ONE.LOOP_ONE){
            clips.get(currentClip).playAsMusic(Settings.get().soundSettings.volume, Settings.get().soundSettings.pitch, true);
        }
        else{
            clips.get(currentClip).playAsMusic(Settings.get().soundSettings.volume, Settings.get().soundSettings.pitch, false);
        }
    }
}
